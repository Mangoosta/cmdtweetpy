...
cuentas_tabla = schema.Table('__main___cuentas',metadata,
...
mensajes_tabla = schema.Table('__main___mensajes',metadata,
    schema.Column('id',types.Integer,primary_key=True),
...
bitacora_tabla = schema.Table('__main___bitacora',metadata,
    schema.Column('id',types.Integer,primary_key=True),
    schema.Column('usuario',types.String(100),nullable=False),
    schema.Column('mensaje',types.String(200),nullable=False),
    schema.Column('tweet',types.String(144),nullable=False),
